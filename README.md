...
В рабочей ветке используется выбранный комплект мана-бура:
...
Теплица получила горизонтальное направление при установке. Передняя грань — контроллер, задняя — стеклянная камера, правая — мана-порт, левая — техническая панель.
