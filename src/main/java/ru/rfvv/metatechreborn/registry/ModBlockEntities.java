...
public final class ModBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<LuckConverterBlockEntity>> LUCK_CONVERTER =
            BLOCK_ENTITIES.register("luck_converter", () -> BlockEntityType.Builder.of(
                    LuckConverterBlockEntity::new, ModBlocks.LUCK_CONVERTER.get(),
                    ModBlocks.ADVANCED_LUCK_CONVERTER.get()).build(null));
