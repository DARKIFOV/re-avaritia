...
public final class ModBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<MolecularAssemblerBlockEntity>> MOLECULAR_ASSEMBLER_9X9 =
            BLOCK_ENTITIES.register("molecular_assembler_9x9",
                    () -> BlockEntityType.Builder.of(MolecularAssemblerBlockEntity::new,
                            ModBlocks.MOLECULAR_ASSEMBLER_9X9.get()).build(null));

    public static final RegistryObject<BlockEntityType<NeutroniumCombinerBlockEntity>> NEUTRONIUM_COMBINER =
            BLOCK_ENTITIES.register("neutronium_combiner",
                    () -> BlockEntityType.Builder.of(NeutroniumCombinerBlockEntity::new,
                            ModBlocks.NEUTRONIUM_COMBINER.get()).build(null));
