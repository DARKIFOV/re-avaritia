...
public final class PatternCapacityUpgradeItem extends Item {
    ...
    public static final int TOTAL_SLOTS = BASE_SLOTS + EXTRA_SLOTS;
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip,
        ...
        tooltip.add(Component.translatable("tooltip.metatech_reborn.pattern_capacity_upgrade",
                        EXTRA_SLOTS, TOTAL_SLOTS)
                .withStyle(ChatFormatting.AQUA));
        tooltip.add(Component.translatable("tooltip.metatech_reborn.pattern_capacity_upgrade.math",
                        BASE_SLOTS, EXTRA_SLOTS, TOTAL_SLOTS)
                .withStyle(ChatFormatting.DARK_AQUA));
        tooltip.add(Component.translatable("tooltip.metatech_reborn.pattern_capacity_upgrade.install")
